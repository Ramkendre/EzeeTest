<%@ Page Title="Update Profile" Language="C#" MasterPageFile="~/Layout/AdminMaster.master"
    AutoEventWireup="true" CodeFile="ChangeDetails.aspx.cs" Inherits="Admin_ChangePassword" %>
                    ...
                    <tr>
                        <td align="center" style="width: 790px">
                            <div style="width: 88%; margin-left: 15px;">
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="tables" style="width: 83%;
                                    margin-left: 102px">
                                    <tr>
                                        ...
                                        <td style="height: 20px;">
                                            <table style="width: 79%; margin-left: 68px;" class="tables" cellspacing="2" cellpadding="2">
                                                <tr>
                                                    ...
                                                    <td colspan="3" align="center" style="text-align: left; font-size: x-large; font-family: 'Times New Roman', Times, serif;">
                                                        <b style="color:Green;">Login Id </b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" colspan="4" style="text-align: left">
                                                        &nbsp;&nbsp;<asp:Label ID="lblError" Visible="false" runat="server" CssClass="error"
                                                            Text="Label"></asp:Label><asp:Label ID="lblSuccess" runat="server" CssClass="error"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 100px; height: 25px; text-align: left;">
                                                        <asp:TextBox ID="txtLoginId" MaxLength="30" ReadOnly="true" runat="server" CssClass="txtcss"
                                                            AutoPostBack="false" TabIndex="1" Height="25px" Width="120px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left" style="width: 23%; text-align: left; height: 10px;">
                                                        <asp:Label ID="lblUserName" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="11pt"
                                                ...
                                                <tr>
                                                    <td align="left" style="width: 23%; text-align: left; height: 9px;">
                                                        <asp:Label ID="lblPassword" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="11pt"
                                                    ...
                                                    <td style="height: 9px; text-align: left;">
                                                        <asp:TextBox ID="txtPassword" runat="server" Height="22px" Width="120px" ValidationGroup="user"
                                                            CssClass="txtcss" MaxLength="20" AutoPostBack="false" TabIndex="1" onkeypress="return numbersonly(this,event)"
                                                            TextMode="Password"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="user" runat="server"
                                                            ControlToValidate="txtPassword" ErrorMessage=" Password is Missing.." Font-Size="12px"></asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left" style="width: 23%; text-align: left; height: 10px;">
                                                        <asp:Label ID="lblRePassword" runat="server" Font-Bold="False" Font-Names="Arial"
                                                            Font-Size="11pt" Text="Re-Password *"></asp:Label>
                                                    </td>
                                                    <td style="height: 10px; text-align: left;">
                                                        <asp:TextBox ID="txtRePassword" Height="25px" Width="120px" ValidationGroup="user"
                                                            onkeypress="return numbersonly(this,event)" CssClass="txtcss" runat="server"
                                                            AutoPostBack="false" TabIndex="1" TextMode="Password"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td align="left" style="width: 23%; text-align: left; height: 7px;">
                                                        <asp:Label ID="lblContactNo" runat="server" Font-Bold="False" Font-Names="Arial"
                                                            Font-Size="11pt" Text=" Contact No *"></asp:Label>
                                                    </td>
                                                    <td style="height: 7px; text-align: left;">
                                                        <asp:TextBox ID="txtContactNo" ValidationGroup="user" CssClass="txtcss" Height="25px"
                                                            Width="120px" onkeypress="return numbersonly(this,event)" runat="server" MaxLength="12"
                                                        ...
                                                        <span>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtContactNo"
                                                                ValidationGroup="user" ErrorMessage="*" Font-Size="Medium"></asp:RequiredFieldValidator></span>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" Font-Size="12px"
                                                            ControlToValidate="txtContactNo" Display="Dynamic" ValidationGroup="user" ErrorMessage="<br>Contact Number must be 8 to 13 digit"
                                                            ValidationExpression="^[0-9]{8,13}$"></asp:RegularExpressionValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left" style="width: 23%; text-align: left; height: 10px;">
                                                        <asp:Label ID="lblAddress" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="11pt"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="height: 25px; text-align: left;">
                                                        <asp:Button ID="btnUpdate" ValidationGroup="user" runat="server" Text="Update" CssClass="btn"
