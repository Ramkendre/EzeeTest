...
public partial class Admin_NewPractice1 : System.Web.UI.Page
{

    string Sql;
    CommonCode cc = new CommonCode();
    NewPractice1BAL newpractice1bal = new NewPractice1BAL();
    string su, ch, le, cl, mat, exam, medium,tpk;
    int j = 0, k = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        mat = Convert.ToString(comboSplit[3]);
        exam = Convert.ToString(comboSplit[4]);
        cl = Convert.ToString(comboSplit[5]);
        medium = Convert.ToString(comboSplit[6]);
        tpk = Convert.ToString(comboSplit[7]);
    ...
    public void getTotalQuesCount()
    {
        try
        {
            ...
            newpractice1bal.Topicid = tpk;
            ds = newpractice1bal.getQuestionNewpracticeCount(newpractice1bal);
    ...
    public void QuesNo(string RowFrom, string RowTo, int quesrounduptemp)
    {
        try
        {
            ...
            ds = newpractice1bal.getQuestionNewpractice(newpractice1bal);
            int k = 1;
