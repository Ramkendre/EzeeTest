<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OnlineExamTest.aspx.cs" Inherits="Admin_OnlineExamTest" %>
            ...
            <center>
                    ...
                    <tr>
                        <td class="header_bg" align="left" valign="bottom" colspan="2">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td class="tdHeader">
                                        &nbsp;<img src="../Images/ezeelogo.JPG" alt="ezeeLogo" style="width: 139px; height: 78px" />
                                    </td>
                                    <td class="tdHeader" align="right">
                                        <span class="loginName">
                                            <asp:Label ID="lblLogin" runat="server" Text="Login"></asp:Label>
                                            <asp:Label ID="lblQues" runat="server" ForeColor="#FFFBD6" Text="Ques:0"></asp:Label>
                                            <asp:Label ID="lblQuesTo" runat="server" ForeColor="#FFFBD6" Text="0"></asp:Label>
                                        </span>
                                        <div id="divTimer" class="displayBlock" style="margin-right: 10px">
                                            <input type="text" name="timer1" disabled="disabled" class="timerControlClass" style="background-color: #976428;" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
                ...
                <table width="70%">
                    <tr>
                        ...
                        <td align="center" style="border: thin groove #C0C0C0">
