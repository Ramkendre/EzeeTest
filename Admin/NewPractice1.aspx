<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewPractice1.aspx.cs" Inherits="Admin_NewPractice1" %>
                                ...
                                <td bgcolor="#F2CE6E" height="30">
                                    <table border="0" height="33" width="100%">
                                        <tr>
                                            ...
                                            <td width="20%">
                                                <div align="center">
                                                    <asp:Button ID="btnexit" runat="server" BackColor="#009900" PostBackUrl="~/Admin/NewPractice.aspx"
