...
public partial class Admin_AddQuestionExam : System.Web.UI.Page
{
    int status;
    ...
    protected void btnStart_Click1(object sender, EventArgs e)
    {
        ...
        QuesNo();    // load first Question and create view of table
    }
    ...
    public void QuesNo()
    {
        try
        {
            ...
            {
                Sql = "select * from tblAssignChapter where AssignUserName='" + Session["LoginId"] + "' and TypeofMaterial='" + rdoTypeofMaterial.SelectedItem.Text + "' and TypeOFExam=" + ddlTypeofExam.SelectedValue + " and Subject_id=" + cmbSelectsubject.SelectedValue + " ";
            }
            else
            {
                Sql = "select * from tblAssignChapter where AssignUserName='" + Session["LoginId"] + "' and TypeofMaterial='" + rdoTypeofMaterial.SelectedItem.Text + "' and Class_id=" + ddlAddClass.SelectedValue + " and Subject_id=" + cmbSelectsubject.SelectedValue + " ";
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                // Sql = "select UniqueId from tblSettings where TypeOFExam=" + TypeOFExam + " and  Class_id=" + Class_id + " and Subject_id=" + Subject_id + " and Chapter_id in('" + Chapter_id + "') ";
                ...
                if (Chapter_id == "1")
                {
                    ...
                    Sql = " CREATE   view " + Session["LoginId"] + " as  " +
                          ...
                          "    from " +
                          "   (select * from tblQuestionAccess where  TypeOFExam=" + TypeOFExam + " and QuestionLevel=" + rdoLevelList1.SelectedValue + " and Class_id=" + Class_id + " and Subject_id=" + Subject_id + "  )  as MyResults ";
                ...
                else
                {
                    ...
                    Sql = " CREATE   view " + Session["LoginId"] + " as  " +
                          " Select ROW_NUMBER() OVER( ORDER BY Question_id) NewQID,  * " +
                          "    from " +
                          "   (select * from tblQuestionAccess where  TypeOFExam=" + TypeOFExam + " and QuestionLevel=" + rdoLevelList1.SelectedValue + " and Class_id=" + Class_id + " and Subject_id=" + Subject_id + " and Chapter_id in(" + Chapter_id + ") )  as MyResults ";
                    int k = cc.ExecuteNonQuery(Sql);
                }
                ...
                {
                    fetchCommonData(dsStatic.Tables[0].Rows[0]);  // bind all data to control 
                }
                lblcount.Text = "Total Number of Question : " + Convert.ToInt32(dsStatic.Tables[0].Rows.Count);
