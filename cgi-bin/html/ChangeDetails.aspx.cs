...
public partial class Admin_ChangePassword : System.Web.UI.Page
{
        ...
        else
        {
            try
            {
               ...
               // user.DOJ = Convert.ToDateTime("01-Apr-2011"); change coding by atul 
                user.DOJ = Convert.ToString(cc.DTInsert_Local("17/10/2013"));
    ...
    //atul validation change

    //protected void txtContactNo_TextChanged(object sender, EventArgs e)
    //     {
    //         string contactNo = Convert.ToString(txtContactNo.Text);
    //         if ( contactNo.Length != 10)
    //         {
    //             txtContactNo.Text = "";
    //             ScriptManager .RegisterStartupScript (this ,typeof (Page),"msg","alert ('please enter minimum 10 digit contact No')",true);
