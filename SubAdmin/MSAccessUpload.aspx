<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Layout/AdminMaster.master"
    CodeFile="MSAccessUpload.aspx.cs" Inherits="SubAdmin_MSAccessUpload" %>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="85%" class="tables">
                            <caption>
                                ...
                                <tr>
                                    <td>
                                        <center>
                                            <h4 style="color: Green; text-align: center; font-size: x-large; font-family: Times New Roman;">Upload EzeeQuestion Database File</h4>
                                        </center>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <center>
                                            <table cellspacing="7px" class="tables" style="width: 90%">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="lblUploadType" runat="server" Font-Size="Medium" Text="Select UplaodType"></asp:Label>
                                                    </td>
                                                    <td colspan="2">
                                                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                            <ContentTemplate>
                                                                <asp:RadioButtonList ID="rdobtnlstUploadType" runat="server" AutoPostBack="True" CssClass="radio"
                                                                    Font-Size="Medium" OnSelectedIndexChanged="rdobtnlstUploadType_SelectedIndexChanged"
                                                                    RepeatDirection="Horizontal">
                                                                    <asp:ListItem Value="0">Questions</asp:ListItem>
                                                                    <asp:ListItem Value="1">Notes</asp:ListItem>
                                                                </asp:RadioButtonList>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="rdobtnlstUploadType"
                                                    ...
                                                    <td colspan="2">
                                                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                            <ContentTemplate>
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="ddlTopic"
                                                                    ErrorMessage="*" Font-Size="Small" InitialValue="1" SetFocusOnError="True" ValidationGroup="other"></asp:RequiredFieldValidator>
                                                                <br />
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label1" runat="server" Font-Size="Medium" Text="Select File "></asp:Label>
                                                    </td>
                                                    <td colspan="2">
