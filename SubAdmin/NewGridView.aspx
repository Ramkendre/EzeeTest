<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Layout/AdminMaster.master" CodeFile="NewGridView.aspx.cs" Inherits="SubAdmin_NewGridView" Title="eZeeTest:Add Question to Test Method 2 New" %>
            ...
            <asp:View ID="View1" runat="server">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        ...
                                        <table style="width: 55%" class="tables" width="160">
                                            <tr>
                                                <td colspan="3" style="text-align: center">
                                                    <h3 style="color: Green; font-size: x-large;">Add Question for Exam &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    </h3>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                                                    <span class="warning2" style="color: Red;">ALL FIELDS ARE MANDATORY.</span>
                                                    <br />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                                                    <asp:Label ID="lblError" runat="server" Font-Bold="true" CssClass="lblError"></asp:Label>
                                                    <br />
                                                    <br />
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddltextName" runat="server" CssClass="ddlcsswidth"
                                            ...
                                            <!--BELOW NEW CHANGES ADD FOR INTERCHANGE QUESTIONS OF DIFFERENT EXAMS DATE := 07.01.2015 (JITENDRA PATIL)-->

                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblTypeofMaterial" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="11pt"
                                                        Text="Select Material" Width="120px"></asp:Label></td>
                                                <td>
                                                    <asp:DropDownList ID="ddlTypeofMaterial" runat="server" CssClass="ddlcsswidth">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                        <asp:ListItem Value="1">Class</asp:ListItem>
                                                        <asp:ListItem Value="2">Competitive Exam</asp:ListItem>
                                                    </asp:DropDownList></td>
                                                <td>
                                                    <%--<asp:RequiredFieldValidator ID="rfvTypeofMaterial" runat="server" ControlToValidate="ddlTypeofMaterial"
                                                        Enabled="True" ErrorMessage="Please Select Type of Material." Font-Size="Small" InitialValue="--Select--"
                                                        SetFocusOnError="True" ValidationGroup="other"></asp:RequiredFieldValidator>--%></td>
                                            </tr>

                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblTypeofQues" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="11pt"
                                                        Text="Select Question" Width="120px"></asp:Label></td>
                                                <td>
                                                    <asp:DropDownList ID="ddlTypeofQues" runat="server" CssClass="ddlcsswidth">
                                                    </asp:DropDownList></td>
                                                <td>
                                                    <%--<asp:RequiredFieldValidator ID="rfvTypeofQues" runat="server" ControlToValidate="ddlTypeofQues"
                                                        Enabled="True" ErrorMessage="Please Select Type of Question." Font-Size="Small" InitialValue="--Select--"
                                                        SetFocusOnError="True" ValidationGroup="other"></asp:RequiredFieldValidator>--%></td>
                                            </tr>

                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblTypeofExam" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="11pt"
                                                        Text="Select Exam" Width="120px"></asp:Label></td>
                                                <td>
                                                    <asp:DropDownList ID="ddlTypeofExam" runat="server" CssClass="ddlcsswidth ">
                                                    </asp:DropDownList></td>
                                                <td>
                                                    <%--<asp:RequiredFieldValidator ID="rfvTypeofExam" runat="server" ControlToValidate="ddlTypeofExam"
                                                        Enabled="True" ErrorMessage="Please Select Type of Exam." Font-Size="Small" InitialValue="--Select--"
                                                        SetFocusOnError="True" ValidationGroup="other"></asp:RequiredFieldValidator>--%></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblClass" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="11pt"
                                                        Text="Select Class" Width="120px"></asp:Label></td>
                                                <td>
                                                    <asp:DropDownList ID="ddlClass" runat="server" CssClass="ddlcsswidth">
                                                    </asp:DropDownList></td>
                                                <td>
                                                    <%--<asp:RequiredFieldValidator ID="rfvClass" runat="server" ControlToValidate="ddlClass"
                                                        Enabled="True" ErrorMessage="Please Select Type of Class." Font-Size="Small" InitialValue="--Select--"
                                                        SetFocusOnError="True" ValidationGroup="other"></asp:RequiredFieldValidator>--%></td>
                                            </tr>

                                            <%--<tr>
                                                <td>
                                                    <asp:Label ID="lblSubject" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="11pt"
                                                        Text="Select Type of Subject" Width="120px"></asp:Label></td>
                                                <td>
                                                    <asp:DropDownList ID="ddlSubject" runat="server" CssClass="ddlcsswidth">
                                                    </asp:DropDownList></td>
                                                <td>
                                                    <asp:RequiredFieldValidator ID="rfvSubject" runat="server" ControlToValidate="ddlSubject"
                                                        Enabled="True" ErrorMessage="Please Select Type of Subject." Font-Size="Small" InitialValue="--Select--"
                                                        SetFocusOnError="True" ValidationGroup="other"></asp:RequiredFieldValidator></td>
                                            </tr>--%>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="container">
                                                        <asp:CheckBox ID="ChkSelectALL" runat="server" Text="Select ALL Topic" OnClick="check(this)"
                                                            Visible="False" />
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">&nbsp;<asp:Button ID="btnStart" runat="server" CssClass="btn" Text="Find Question"
                    ...
                    <Triggers>
                        ...
                        <asp:PostBackTrigger ControlID="ddlTopik" />
                    </Triggers>
                </asp:UpdatePanel>
            </asp:View>
