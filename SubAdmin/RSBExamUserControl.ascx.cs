...
public partial class SubAdmin_RSBExamUserControl : System.Web.UI.UserControl
{
    ...
    public void loadControl(string reqQid)
    {
        try
        {
            ...
            //if (defId != "")
            //{
            //    s11 = "tbl5119";// + Convert.ToString(Session["TestID"]);
            //}

            //string sql = "select  ROW_NUMBER()over(order by SNO)as EQID,* from " + s11 +
            //     " inner join tblItemValue on tblItemValue.ItemValueId=" + s11 + ".TypeofQues" +
            // " where EQID=" + reqQid;
