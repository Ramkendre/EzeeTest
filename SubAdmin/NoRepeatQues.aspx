<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NoRepeatQues.aspx.cs" MasterPageFile="~/Layout/AdminMaster.master"
    Inherits="SubAdmin_NoRepeatQues" %>
                ...
                <asp:View ID="View1" runat="server">
                    <div style="width: 100%;" align="center">
                        <table>
                            <tr>
                                <th>
                                    <asp:Label ID="lblhead" runat="server" Font-Size="Medium" Font-Names="Tahoma" Text="No Repeat Questions "
                        ...
                        <table style="width: 50%; height: 100px; border: 2px solid black; vertical-align: text-top;">
                            ...
                            <%--<tr>
                        <td>
                            <b>Select Class Name :</b>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlClassName" runat="server">
                            </asp:DropDownList>
                           <%-- <asp:RequiredFieldValidator ID="reqddlClassName" runat="server" ControlToValidate="ddlClassName"
                                ErrorMessage=" * Required " InitialValue="1"></asp:RequiredFieldValidator>--%>
                            <%--  </td>
                    </tr>--%>
                            <tr>
                ...
                <asp:View ID="View2" runat="server">
                    <div style="width: 100%" align="center">
                        <div style="width: 60%;" align="center">
                            ...
                            <asp:GridView ID="gvBindTestName" AutoGenerateColumns="false" DataKeyNames="Test_ID"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Select Test">
                                        ...
                                        <ItemTemplate>
                                            <center>
                                                <asp:CheckBox ID="chk1" runat="server" ToolTip="Select Question to Add in Exam" />
                            ...
                            &nbsp;&nbsp;
                            <asp:Button ID="btnAddTest" Text="Add Test" CssClass="btn" runat="server" OnClick="btnAddTest_Click" />
                        </div>
                    </div>
                    <%--<asp:LinkButton ID="lnkbtnEnterCode" runat="server" CssClass="lnkbtnerror" Text="Click Here To Enter Your Code...!!!" PostBackUrl="~/SubAdmin/RSBCustomerTestDefine.aspx"></asp:LinkButton>--%><br />
                </asp:View>
            </asp:MultiView>
        </ContentTemplate>
    </asp:updatepanel>
