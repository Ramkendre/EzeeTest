<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TakePracticeByTest1.aspx.cs"
    Inherits="SubAdmin_TakePracticeByTest1" %>
                                ...
                                <td bgcolor="#F2CE6E" height="30">
                                    <table border="0" height="33" width="100%">
                                        <tr>
                                            ...
                                            <td width="20%">
                                                <div align="center">
                                                    <asp:Button ID="btnexit" runat="server" BackColor="#009900" PostBackUrl="~/SubAdmin/TakePracticeByTest.aspx"
