...
public partial class SubAdmin_TakePracticeByTest1 : System.Web.UI.Page
{
    ...
    {
        string combo = Convert.ToString(Request.QueryString["Id"]);
    ...
    public void getTotalQuesCount()
    {
        ...
        try
        {
            ...
            Sql = "Select * from tbl5164 where TestID='" + combo + "' ";
    ...
    public void QuesNo(string RowFrom, string RowTo, int quesrounduptemp)
    {
        try
        {
            ...
            Sql = " ;with T as( Select ROW_NUMBER()over(order by  SNO)as ID,[SNO],[Question],[QType],[Answer1] ,[AType],[Answer2] ,[BType] ,[Answer3],[CType] ,[Answer4],[DType] " +
                  ...
                  " ,[Qhint] ,[hType] ,[Correct_answer] ,[QuestionLevel]  ,[TypeofQues]  ,[TypeofDB],[Sellanguage]  from tbl5164 where TestID='" + combo + "' )select * from T  where ID>='" + RowFrom + "'  and ID<='" + RowTo + "' ";
            ...
            if (row.ItemArray.Count() > 0)
            {
                ...
                else
                {
                    ...
                    if (val.Length == 3)
                    {
                        ...
                        imgHint2.ImageUrl = "~/HintPracticeHandler.ashx?para=" + NewQID + ",Qhint";
    ...
    protected void btnGoto_Click(object sender, EventArgs e)
    {
        if (txtgoto.Text != "")
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, typeof(Page), "msg", "alert('Total Available Question are Less!!!!! ')", true);
            }
        }
    }
