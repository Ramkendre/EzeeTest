...
public partial class SubAdmin_RSBexTest : System.Web.UI.Page
{
    ...
    void data()
    {
        try
        {
            ...
            Sql = "select SNO from " + lblTestId.Text + "  where TestID='" + testID + "' ";
            ...
            // sql1 = " SELECT TOP 100 percent  * FROM " + lblTestId.Text + " ORDER BY NEWID() ";
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                if (flagInstr == false)
                {
                    ...
                    Control ctl = LoadControl("~/SubAdmin/RSBInstructionControl.ascx");  //?reqQid=" + ds.Tables[0].Rows[i]["Question_id"]);                
                    ctl.ID = "UC" + "-1";
                ...
                if (flagInstr == true)
                {
                    ...
                    Control ctl1 = LoadControl("~/SubAdmin/RSBExamUserControl.ascx");  //?reqQid=" + ds.Tables[0].Rows[i]["Question_id"]);                
                    ctl1.ID = "UC" + i;
                    ...
                    if (i == Convert.ToInt32(lblQuesTo.Text))
                    {
                        ...
                        Control ctl = LoadControl("~/SubAdmin/RSBExamReportControl.ascx");  //?reqQid=" + ds.Tables[0].Rows[i]["Question_id"]);                
                        ctl.ID = "UC_Finish";
