<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RSBexTest.aspx.cs" Inherits="SubAdmin_RSBexTest" %>
        ...
        function GetListItem() {
            ...
            try {
                ...
                if (typeQues == "Type of Question : Basic Type" || typeQues == "Type of Question : Question On Passage" || typeQues == "Type of Question : Reasoning Type")
                     ...
                     {
//                         if ($('#<%=rdoAnswerlist.ClientID%> checked').val() != undefined) 
//                    {
//                        examAns[Qno1] = $('#<%=rdoAnswerlist.ClientID %> checked').val();
                         //                    }
...
<body onkeydown="return disableCntrl(event)">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td class="tdHeader" rowspan="3">
                                    &nbsp;<img src="../Images/it.jpg" alt="Logo Image Abhinav IT Solutions" style="width: 139px; height: 78px" />&nbsp;
                                </td>
                                <td class="tdHeader">
                        ...
                        <td colspan="2">
                            <table id="tblAnswer" class="displayBlock" width="100%">
                                <tr>
                                    ...
                                    <td></td>
                                    <td colspan="3"><br />
                                    <asp:Label ID="lblCountSolved" runat="server" Text="Solved" Font-Bold="true" ForeColor="Green" Visible="false"></asp:Label> &nbsp;
                                    
                                    </td>
                                    <td colspan="4"><br />
                                    <asp:Label ID="lblCountUnSolved" runat="server" Text="Unsolved" Font-Bold="true" ForeColor="Red" Visible="false"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
