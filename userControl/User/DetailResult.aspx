<%@ Page Language="C#" MasterPageFile="~/Layout/Master.master"  AutoEventWireup="true" CodeFile="DetailResult.aspx.cs" Inherits="DetailResult" Title="Detail Result" %>
    ...
    <table cellpadding="0" cellspacing="0" width="85%" border="1" ><tr><td align="center" >
       ...
       <table style="width: 100%; font-weight: bold;" class="tables" cellspacing="7px">
        ...
        <asp:Button ID="btnback" runat="server" Text="Back" 
                  CssClass="btn" 
                    PostBackUrl="~/User/Timeover.aspx" onclick="btnback_Click" />
    <br />
    </td></tr></table></div>
    <div class="grid" style="width: 95%">
                <div class="rounded">
                    ...
                    <div class="mid-outer">
                        ...
                        AllowPaging="True" CellPadding="5" CellSpacing="0"
