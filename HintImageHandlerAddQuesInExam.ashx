<%@ WebHandler Language="C#" Class="HintImageHandlerAddQuesInExam" %>
...
public class HintImageHandlerAddQuesInExam : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) 
    {
        ...
        try
        {
            string sql = "select " + para[1] + " from  tbll" + para[2] + " where NewQID=" + para[0] + "";
