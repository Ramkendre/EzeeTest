<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ExamReportControl.ascx.cs"
    Inherits="ExamReportControl" %>
...
<div style="width: 100%;">
    <center>
        ...
        <asp:Button ID="btnBackToTestHome" runat="server" Text="Back" PostBackUrl="~/Admin/TestHome.aspx" 
            onclick="btnBackToTestHome_Click" /> 
